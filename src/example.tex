...
%   \colorbox{jqdark}{%
%     \textcolor{white}{%
%       \fontsize{6}{7}\selectfont\quad MY INSTITUTION\quad%
%     }%
%   }%
% }
...
\begin{frame}{Minimal example}
    Use the JacquenettaModified theme with a single line in your preamble:

    \vspace{0.1cm}
    {\small\ttfamily
    \textbackslash documentclass[aspectratio=169]\{beamer\}\\
    \textbackslash usetheme\{JacquenettaModified\}\\[2pt]
...
\begin{frame}{Theme options}
    \vspace{-0.7cm}
    JacquenettaModified supports the following options:
    \vspace{0.3cm}
    \begin{tabular}{ll}
        \toprule
    ...
    \vspace{0.5cm}
    {\small\ttfamily
    \textbackslash usetheme[accent=teal]\{JacquenettaModified\}\\
    \textbackslash usetheme[noborder]\{JacquenettaModified\}\\
    \textbackslash usetheme[accent=jqorange, noborder]\{JacquenettaModified\}
    }
\end{frame}
...
\begin{frame}{Font styles}
    JacquenettaModified uses URW Classico for body text and
...
\begin{frame}{Mathematics}
    JacquenettaModified preserves serif fonts in math mode for readability.
...
\begin{frame}{Tables}
    Use booktabs for clean, professional tables.
...
\begin{frame}{Color palette}
    JacquenettaModified defines four theme colors:
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.22\textwidth}
            ...
            \end{tikzpicture}\\[4pt]
            {\small\ttfamily \#E67E22}
        \end{column}
    \end{columns}

    \vspace{0.6cm}
    Use them directly: \texttt{\color{jqblue}\textbackslash color\{jqblue\}} or
    \texttt{\textbackslash textcolor\{jqorange\}\{...\}}.

    \vspace{0.2cm}
    The accent color (default: {\color{jqaccent}blue})
    controls the problock border and standard block titles.
\end{frame}
...
\begin{frame}{Summary}
    \begin{problock}{JacquenettaModified at a glance}
        \begin{itemize}
    ...
    \begin{highlightbox}
        ...
        \texttt{\textbackslash usetheme\{JacquenettaModified\}}
    \end{highlightbox}
\end{frame}
