...
Classico as the sans-serif text font. 
...
Distribution and modification of these fonts is allowed
subject to the Alladin General Public License, which 
is included in the archive as
